...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    async function loadTransactions(): Promise<void> {
      ...
      const dataTransactions = responseTransactions.map(transaction => {
        const transactionP = transaction;
        transactionP.formattedValue = formatValue(transaction.value);
        transactionP.formattedDate = formatDate(transaction.created_at);
        return transactionP;
      });
